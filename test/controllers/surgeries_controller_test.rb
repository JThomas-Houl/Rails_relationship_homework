...
class SurgeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create surgery" do
    assert_difference('Surgery.count') do
      post surgeries_url, params: { surgery: { GP_age: @surgery.GP_age, GP_gender: @surgery.GP_gender, GP_name: @surgery.GP_name } }
    end
  ...
  test "should update surgery" do
    patch surgery_url(@surgery), params: { surgery: { GP_age: @surgery.GP_age, GP_gender: @surgery.GP_gender, GP_name: @surgery.GP_name } }
